...
Partial Public Class PalindromeCheckPage
    ...
    '''Modificar a declaração do campo de movimento do arquivo de designer para o arquivo code-behind.
    '''</remarks>
    Protected WithEvents btnPalindromeCheckAjax As Global.System.Web.UI.HtmlControls.HtmlButton

    '''<summary>
    '''Controle btnPalindromeCheckJS.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Modificar a declaração do campo de movimento do arquivo de designer para o arquivo code-behind.
